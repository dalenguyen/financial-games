...
function result() {
  ...
  // Check the results
  if (compare2Objects(assets, assetResult) && compare2Objects(liabilities, liabilityResult) && compare2Objects(equity, equityResult)) {
    __WEBPACK_IMPORTED_MODULE_0_sweetalert2___default()('Good job!', 'You solved it!', 'success');
  } else {
    __WEBPACK_IMPORTED_MODULE_0_sweetalert2___default()('Oops...', 'Please try again!', 'error');
  }
}
